...
| Platform                | Download                                                                      |
| ----------------------- | ----------------------------------------------------------------------------- |
| Windows                 | [Setup (.exe)](https://github.com/SavageCore/RoNModManager/releases/latest)   |
| Linux - AppImage        | [AppImage](https://github.com/SavageCore/RoNModManager/releases/latest)       |
| Linux - Debian/Ubuntu   | [.deb package](https://github.com/SavageCore/RoNModManager/releases/latest)   |
| Linux - Fedora/openSUSE | [.rpm package](https://github.com/SavageCore/RoNModManager/releases/latest)   |
| Linux - Arch (AUR)      | [ronmodmanager-bin](https://aur.archlinux.org/packages/ronmodmanager-bin)     |
| Linux - Flatpak         | [Flatpak bundle](https://github.com/SavageCore/RoNModManager/releases/latest) |
...
Alternatively, download `ronmodmanager.flatpak` from the [latest release](https://github.com/SavageCore/RoNModManager/releases/latest) and install directly:
