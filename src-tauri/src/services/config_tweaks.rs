...
pub fn available_gpu_profiles() -> Vec<String> {
    vec![
        "GTX_1050_Ti__4_GB_","GTX_1060_6GB","GTX_1650","GTX_1650_Super","GTX_1660","GTX_1660_Super","GTX_970","GTX_980",
        "RTX_2060-2060_Super","RTX_2070-_2070_Super","RTX_3050","RTX_3050_Ti","RTX_3060-3060_Ti","RTX_3070-3070_Ti","RTX_3080-3080_Ti","RTX_3090-3090_Ti",
        "RTX_4060","RTX_4060_Ti","RTX_4070","RTX_4070_Ti-4070_Super","RTX_4080-4080_Super","RTX_4090",
        "RX_5500_XT_8GB","RX_550__2_GB_","RX_5600_XT","RX_560__4_GB_","RX_5700-5700_XT","RX_570__4_GB_","RX_580_4_GB_version","RX_580_8GB","RX_590","RX_6500_XT","RX_6600-6600_XT","RX_6600_M","RX_6700_XT","RX_6750_XT","RX_6800","RX_6800_XT","RX_6900_XT","RX_6950_XT","RX_7900_XT","RX_7900_XTX",
    ].into_iter().map(String::from).collect()
}

fn profile_bytes(profile: &str) -> Option<&'static [u8]> {
    match profile {
        "GTX_1050_Ti__4_GB_" => Some(include_bytes!("../../assets/optimization/GTX_1050_Ti__4_GB_.ini")),
        ...
        "GTX_1650_Super" => Some(include_bytes!("../../assets/optimization/GTX_1650_Super.ini")),
        "GTX_1660" => Some(include_bytes!("../../assets/optimization/GTX_1660.ini")),
        "GTX_1660_Super" => Some(include_bytes!("../../assets/optimization/GTX_1660_Super.ini")),
        "GTX_970" => Some(include_bytes!("../../assets/optimization/GTX_970.ini")),
        "GTX_980" => Some(include_bytes!("../../assets/optimization/GTX_980.ini")),
        "RTX_2060-2060_Super" => Some(include_bytes!("../../assets/optimization/RTX_2060-2060_Super.ini")),
        "RTX_2070-_2070_Super" => Some(include_bytes!("../../assets/optimization/RTX_2070-_2070_Super.ini")),
        ...
        "RTX_3060-3060_Ti" => Some(include_bytes!("../../assets/optimization/RTX_3060-3060_Ti.ini")),
        "RTX_3070-3070_Ti" => Some(include_bytes!("../../assets/optimization/RTX_3070-3070_Ti.ini")),
        "RTX_3080-3080_Ti" => Some(include_bytes!("../../assets/optimization/RTX_3080-3080_Ti.ini")),
        "RTX_3090-3090_Ti" => Some(include_bytes!("../../assets/optimization/RTX_3090-3090_Ti.ini")),
        ...
        "RTX_4070_Ti-4070_Super" => Some(include_bytes!("../../assets/optimization/RTX_4070_Ti-4070_Super.ini")),
        "RTX_4080-4080_Super" => Some(include_bytes!("../../assets/optimization/RTX_4080-4080_Super.ini")),
        "RTX_4090" => Some(include_bytes!("../../assets/optimization/RTX_4090.ini")),
        "RX_5500_XT_8GB" => Some(include_bytes!("../../assets/optimization/RX_5500_XT_8GB.ini")),
        "RX_550__2_GB_" => Some(include_bytes!("../../assets/optimization/RX_550__2_GB_.ini")),
        "RX_5600_XT" => Some(include_bytes!("../../assets/optimization/RX_5600_XT.ini")),
        "RX_560__4_GB_" => Some(include_bytes!("../../assets/optimization/RX_560__4_GB_.ini")),
        "RX_5700-5700_XT" => Some(include_bytes!("../../assets/optimization/RX_5700-5700_XT.ini")),
        "RX_570__4_GB_" => Some(include_bytes!("../../assets/optimization/RX_570__4_GB_.ini")),
        "RX_580_4_GB_version" => Some(include_bytes!("../../assets/optimization/RX_580_4_GB_version.ini")),
        ...
        "RX_6600-6600_XT" => Some(include_bytes!("../../assets/optimization/RX_6600-6600_XT.ini")),
...
pub fn get_profile_content(profile: &str) -> Result<Vec<u8>> {
    ...
    Err(AppError::Validation(format!("unknown GPU profile: {profile}")))
}

pub fn apply_optimization(profile: &str) -> Result<()> {
    let ini = get_engine_ini_path()?;
    if let Some(parent) = ini.parent() { fs::create_dir_all(parent).map_err(|e| AppError::Validation(e.to_string()))?; }
...
fn gpu_string() -> Option<String> {
    ...
    for cmd in [
        ...
        if let Ok(out) = std::process::Command::new(cmd.0[0]).args(&cmd.0[1..]).output() {
            let text = String::from_utf8_lossy(&out.stdout).to_lowercase();
            let relevant = if let Some(needle) = cmd.1 {
                text.lines().find(|l| l.contains(needle)).unwrap_or(&text).to_string()
            } else { text.to_string() };
            if relevant.contains("rtx") || relevant.contains("gtx") || relevant.contains(" radeon") || relevant.contains(" rx ") {
                return Some(relevant);
            }
        }
    }
    std::process::Command::new("lspci").output().ok()
        .map(|o| String::from_utf8_lossy(&o.stdout).to_lowercase().to_string())
}
...
pub fn detect_gpu() -> Option<String> {
    ...
    if s.contains("4090") { return Some("RTX_4090".to_string()); }
    for p in profiles {
