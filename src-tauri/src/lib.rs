...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ue4ss_commands::get_ue4ss_mod_config,
            ue4ss_commands::set_ue4ss_mod_config,
            ue4ss_commands::get_ue4ss_lua_config,
            ue4ss_commands::set_ue4ss_lua_config,
            ue4ss_commands::revert_ue4ss_lua_config,
